...
ClimaModel climaModel = new ClimaModel();
    ...
    public String inicio() throws IOException, InterruptedException{
        ...
        return "A temperatura é de "+ temperatura+ "°C em " + climaModel.getCityName() +"-"+climaModel.getStateCode()+".";
    }

    public void pegarPorCidade(String cityName) throws IOException, InterruptedException{
        climaModel.setCityName(cityName.toUpperCase());
    }
}
